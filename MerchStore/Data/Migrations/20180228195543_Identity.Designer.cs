...
namespace MerchStore.Migrations
{
    ...
    [Migration("20180228195543_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MerchStore.Data.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("MerchStore.Data.Entities.Order", b =>
                {
                    b.HasOne("MerchStore.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MerchStore.Data.Entities.StoreUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
